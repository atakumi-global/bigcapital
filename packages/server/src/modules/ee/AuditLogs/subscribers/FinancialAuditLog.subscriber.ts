...
export class FinancialAuditLogSubscriber {
  ...
  async onContactActivated({
    ...
    const subject =
      contact.contactService === 'vendor'
        ? AbilitySubject.Vendor
        : AbilitySubject.Customer;
